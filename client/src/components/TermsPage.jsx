    ...
    <div className="lp-page">
      ...
      <main className="lp-main">
        <div className="lp-doc-header">
          ...
          <p className="lp-doc-subtitle">Leé con atención antes de usar FeelReady.</p>
        </div>
        ...
        <div className="lp-layout">
          ...
          <article className="lp-content">
            <section id="s1" className="lp-section">
              ...
              <p>Al acceder o utilizar FeelReady (en adelante, "el Servicio", "la Plataforma" o "FeelReady"), disponible en feelready.io, usted ("Usuario") acepta quedar vinculado por estos Términos y Condiciones. Si no está de acuerdo con alguna parte de estos términos, no debe utilizar el Servicio.</p>
            </section>
            ...
            <section id="s2" className="lp-section">
              ...
              <p>Las funcionalidades del Servicio pueden evolucionar, ampliarse o modificarse en cualquier momento a discreción de FeelReady, con la finalidad de ofrecer experiencias de coaching más completas.</p>
            </section>
            ...
            <section id="s4" className="lp-section">
              ...
              <ul>
                ...
                <li>Notificar a FeelReady ante cualquier uso no autorizado de su cuenta</li>
              </ul>
              <p>FeelReady no será responsable por pérdidas derivadas del uso no autorizado de la cuenta del usuario cuando éste no haya cumplido con las obligaciones de seguridad anteriores.</p>
            </section>

            <section id="s5" className="lp-section">
              <h2>5. Planes y pagos</h2>
              <p>FeelReady ofrece un plan gratuito con funcionalidades limitadas y planes de pago ("Plan Premium") que otorgan acceso a funcionalidades adicionales.</p>
              ...
              <p>Los pagos son procesados por proveedores externos de confianza. FeelReady puede utilizar uno o varios procesadores de pago, incluyendo pero no limitándose a Stripe, Mercado Pago u otros proveedores equivalentes. El uso de dichos servicios está sujeto a los términos y condiciones propios de cada proveedor.</p>

              <h3>5.4 Política de reembolsos</h3>
              <p>Salvo que la legislación aplicable en la jurisdicción del usuario establezca lo contrario, FeelReady no otorga reembolsos por períodos no utilizados ni por cancelaciones anticipadas de suscripciones activas.</p>
              <p>En jurisdicciones donde la normativa de protección al consumidor reconozca un derecho de desistimiento (como la Unión Europea, que establece 14 días naturales, o legislaciones similares), el usuario podrá ejercer dicho derecho contactando a <a href="mailto:support@feelready.io">support@feelready.io</a> dentro del plazo legal correspondiente, siempre que no haya hecho uso efectivo del servicio contratado.</p>

              <h3>5.5 Cancelación</h3>
              <p>El usuario puede cancelar su suscripción en cualquier momento desde la configuración de su cuenta o contactando a <a href="mailto:support@feelready.io">support@feelready.io</a>. La cancelación tendrá efecto al finalizar el período de facturación en curso.</p>
            </section>
            ...
            <section id="s6" className="lp-section">
              ...
              <ul>
                ...
                <li>Suplantar la identidad de otros usuarios o de FeelReady</li>
            ...
            <section id="s7" className="lp-section">
              ...
              <p>Todo el contenido de FeelReady, incluyendo pero no limitándose a textos, gráficos, logotipos, iconos, imágenes, audio, código fuente y software, es propiedad de FeelReady o de sus licenciantes y está protegido por las leyes de propiedad intelectual aplicables.</p>
              ...
              <p>Los usuarios conservan la titularidad de los contenidos que generen o proporcionen en la Plataforma (como respuestas en entrevistas o información de perfil), pero otorgan a FeelReady una licencia no exclusiva, mundial y libre de regalías para utilizar dicho contenido con el fin de operar, mejorar y desarrollar el Servicio, en los términos descritos en la Política de Privacidad.</p>
            </section>
            ...
            <section id="s9" className="lp-section">
              ...
              <p>En la máxima medida permitida por la ley aplicable, FeelReady no será responsable por:</p>
              <ul>
              ...
              <p>Nada en estos Términos excluye o limita la responsabilidad de FeelReady en los casos en que la legislación aplicable no permita dicha exclusión o limitación, incluyendo la responsabilidad por dolo o culpa grave.</p>
            </section>

            <section id="s10" className="lp-section">
              <h2>10. Modificaciones del Servicio y de los Términos</h2>
              <p>FeelReady se reserva el derecho de modificar, suspender o discontinuar el Servicio, o cualquier parte del mismo, en cualquier momento y por cualquier motivo, con o sin previo aviso.</p>
              <p>Asimismo, FeelReady puede modificar estos Términos periódicamente. Las modificaciones serán notificadas al usuario mediante publicación en la Plataforma y/o por correo electrónico. El uso continuado del Servicio tras la publicación de los cambios constituye la aceptación de los nuevos Términos.</p>
            </section>

            <section id="s11" className="lp-section">
              <h2>11. Cancelación y suspensión de cuenta</h2>
              <p>FeelReady puede suspender o eliminar la cuenta de un usuario, sin previo aviso ni responsabilidad, en caso de incumplimiento de estos Términos o por cualquier otro motivo que a su criterio justifique tal medida.</p>
            </section>
            ...
            <section id="s13" className="lp-section">
              <h2>13. Contacto</h2>
              <p>Para cualquier consulta relacionada con estos Términos, puede contactarnos en: <a href="mailto:support@feelready.io">support@feelready.io</a></p>
            </section>
          </article>
        </div>
      </main>
