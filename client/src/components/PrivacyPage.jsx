        ...
        <div className="lp-layout">
          ...
          <article className="lp-content">
            <section id="p1" className="lp-section">
              ...
              <p>Esta Política de Privacidad describe cómo FeelReady recopila, utiliza, almacena y protege la información personal de sus usuarios. Al utilizar el Servicio, el usuario acepta las prácticas descritas en este documento.</p>
              <p>FeelReady está comprometida con la protección de la privacidad de sus usuarios y con el cumplimiento de las legislaciones aplicables, incluyendo el Reglamento General de Protección de Datos (RGPD) de la Unión Europea, la Ley N.° 25.326 de Protección de Datos Personales de Argentina, la Ley Federal de Protección de Datos Personales en Posesión de los Particulares de México, la Ley N.° 19.030 de Uruguay y demás normativas aplicables según la jurisdicción del usuario.</p>
            </section>
            ...
            <section id="p3" className="lp-section">
              ...
              <p>FeelReady utiliza la información recopilada para los siguientes fines:</p>
              <ul>
            ...
            <section id="p5" className="lp-section">
              ...
              <p>FeelReady no vende ni alquila los datos personales de sus usuarios a terceros. Sin embargo, puede compartir información en los siguientes casos:</p>
              <ul>
                <li><strong>Proveedores de servicios:</strong> empresas que prestan servicios en nombre de FeelReady, incluyendo proveedores de infraestructura en la nube, servicios de inteligencia artificial (como Anthropic), servicios de síntesis de voz, procesadores de pago y herramientas de análisis. Dichos proveedores únicamente pueden tratar los datos en la medida necesaria para prestar sus servicios y están sujetos a obligaciones de confidencialidad</li>
                <li><strong>Cumplimiento legal:</strong> cuando sea requerido por ley, orden judicial o autoridad competente</li>
                <li><strong>Protección de derechos:</strong> cuando sea necesario para proteger los derechos, la propiedad o la seguridad de FeelReady, sus usuarios u terceros</li>
            ...
            <section id="p6" className="lp-section">
              ...
              <p>Los servicios de FeelReady pueden involucrar transferencias de datos a servidores ubicados fuera del país de residencia del usuario, incluyendo países que pueden no contar con un nivel de protección equivalente al de la Unión Europea u otras jurisdicciones. En tales casos, FeelReady adopta las salvaguardias adecuadas conforme a la normativa aplicable, tales como cláusulas contractuales tipo u otros mecanismos reconocidos.</p>
            </section>

            <section id="p7" className="lp-section">
              <h2>7. Retención de datos</h2>
              <p>FeelReady almacena los datos personales de los usuarios de forma indefinida mientras la cuenta esté activa, con el propósito de mantener el historial de sesiones y permitir la mejora continua del Servicio. El usuario puede solicitar la eliminación de sus datos en cualquier momento conforme a lo establecido en la sección de derechos del usuario.</p>
              <p>Tras la eliminación de la cuenta o la solicitud de borrado, FeelReady eliminará o anonimizará los datos del usuario en un plazo razonable, salvo que exista una obligación legal de conservarlos.</p>
            </section>
            ...
            <section id="p8" className="lp-section">
              ...
              <ul>
                <li><strong>Acceso:</strong> conocer qué datos personales trata FeelReady sobre él</li>
              ...
              <p>Para ejercer cualquiera de estos derechos, el usuario puede escribir a: <a href="mailto:support@feelready.io">support@feelready.io</a></p>
              <p>FeelReady responderá en los plazos establecidos por la legislación aplicable (en general, dentro de los 30 días siguientes a la recepción de la solicitud). Si el usuario considera que sus derechos no han sido atendidos, puede presentar una reclamación ante la autoridad de protección de datos competente en su jurisdicción.</p>
            </section>

            <section id="p9" className="lp-section">
              <h2>9. Seguridad de los datos</h2>
              <p>FeelReady implementa medidas técnicas y organizativas apropiadas para proteger los datos personales contra acceso no autorizado, pérdida, alteración o divulgación, incluyendo el cifrado de datos en tránsito y en reposo, controles de acceso y monitoreo de seguridad.</p>
              <p>Sin embargo, ningún sistema es completamente infalible. En caso de una brecha de seguridad que afecte los datos del usuario, FeelReady notificará a los afectados y a las autoridades competentes conforme a lo exigido por la ley.</p>
            </section>

            <section id="p10" className="lp-section">
              <h2>10. Cookies y tecnologías similares</h2>
              <p>FeelReady puede utilizar cookies y tecnologías similares para mejorar la experiencia del usuario, analizar el uso del Servicio y personalizar el contenido. El usuario puede gestionar sus preferencias de cookies desde la configuración de su navegador.</p>
            </section>

            <section id="p11" className="lp-section">
              <h2>11. Menores de edad</h2>
              <p>Los menores de 18 años pueden utilizar el Servicio con el consentimiento de su padre, madre o tutor legal. FeelReady no recopila conscientemente información de menores sin dicho consentimiento. Si un padre, madre o tutor detecta que su hijo ha proporcionado datos sin autorización, puede contactarnos en <a href="mailto:support@feelready.io">support@feelready.io</a> para solicitar su eliminación.</p>
              <p>En jurisdicciones donde la legislación establezca una edad mínima de consentimiento digital distinta (como los 16 años en algunos países de la Unión Europea o los 13 años bajo la COPPA en Estados Unidos), FeelReady cumplirá con los requisitos locales aplicables.</p>
            </section>

            <section id="p12" className="lp-section">
              <h2>12. Cambios en esta Política</h2>
              <p>FeelReady puede actualizar esta Política periódicamente. Los cambios serán publicados en la Plataforma e indicarán la fecha de la última actualización. Se recomienda al usuario revisar esta Política de forma regular.</p>
            </section>

            <section id="p13" className="lp-section">
              <h2>13. Contacto</h2>
              <p>Para consultas relacionadas con privacidad y protección de datos: <a href="mailto:support@feelready.io">support@feelready.io</a></p>
            </section>
          </article>
        </div>
      </main>
